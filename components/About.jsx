      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col xl:flex-row ">
          ...
          <div className="hidden xl:flex flex-1 relative">
            {/* shakal */}
            <div className="w-46 h-46 overflow-hidden rounded-full">
              <Image src='/logo.png'layout="fill" objectFit="cover" alt="Profile Image" />
            </div>
                ...
                <TabsContent value="personal">
                  <div className="text-center xl:text-left ">
                    ...
                    <p className="subtitle max-w-xl max-auto xl:mx-0">
                      Ispecialise in crafting in crafting intuitive webssites
                    ...
                    <div className="grid xl:grid-cols-2 gap-4 mb-12">
                      {infoData.map((item, index) => {
                        return (
                          <div
                            className="flex items-center gap-x-4mx-auto xl:mx-0"
                            key={index}>
