...
<div className='pt-5'>
   ...
   <Link href="#experiance">  <button  className='herobutton px-6 py-2 border border-[#242424] rounded-full uppercase text-xs tracking-widest test-gray-500 transition-all hover:border[#F7AB0A]/40 hover:text-[#f7AB0A]/40'>Experience</button></Link>
