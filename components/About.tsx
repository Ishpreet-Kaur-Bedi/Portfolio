...
export default function About({}: Props) {
  return (
    <div>
      ...
      >
        <h3 className="absolute top-24 p-5 md:top-0 uppercase tracking-[20px] text-gray-500 text-2xl">
          About
        </h3>
        <motion.img
          initial={{
          ...
          className="-mb-20 md:-mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[500px] xl:h-[600px] md:mt-8"
          alt="Profile Image"
        />

        <div className="space-y-10 px-0 md:px-10 mt-8 md:mt-0">
          {/* Added a top margin for mobile devices */}
